...
public final class PhraseAnalysis {
     ...
     * @throws NoteListException if there are no <A HREF="#Note">notes</A> in the Note
     *                           array
     */
     ...
     * @throws NoteListException if there are less than two <A HREF="#Note">notes</A> in
     *                           the Phrase
     */
     ...
     * @throws NoteListException if there are less than three <A HREF="#Note">notes</A>
     *                           in the Phrase
     */
     ...
     * @throws NoteListException if the melody does not have more <A HREF="#Note">
     ...
     * quanta.
     * @throws QuantisationException if the Notes' rhythm values are not multiples of the
